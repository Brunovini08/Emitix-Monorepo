...
import { TCfop } from "src/core/cte/types/TCfop";
import { TFinCTe } from "src/core/cte/types/TFinCTe";
import { TProcEmi } from "src/core/cte/types/TProcEmi";
import { TAmb } from "src/core/nfe/reusable/types/primitivies_types/TAmb";
import { TCodUfIBGE } from "src/core/nfe/reusable/types/primitivies_types/TCodUfIBGE";
import { TDateTimeUTC } from "src/core/nfe/reusable/types/primitivies_types/TDateTimeUTC";
import { TNF } from "src/core/nfe/reusable/types/primitivies_types/TNF";
import { TSerie } from "src/core/nfe/reusable/types/primitivies_types/TSerie";
import { TString } from "src/core/nfe/reusable/types/primitivies_types/TString";
import { ISSQNtotDto } from "src/resources/common/dtos/infNfe/total/ISSQNtot/ISSQNtot.dto";
