...
import { ObsContMapper } from "../nfe-emitir/infAdic/obsCont.mapper";
import { ObsFiscoMapper } from "../nfe-emitir/det/obsItem/obsFisco.mapper";
import { ProcRefMapper } from "../nfe-emitir/infAdic/proceRef.mapper";
