...
export class ICMS90 {
  ...
  public validateOrThrow() {
    ...
    if (this.CST !== '90') {
      throw new DomainError('CST para ICMS90 deve ser obrigatoriamente "90".');
    }
    ...
    if (this.vBCFCP !== undefined && (typeof this.vBCFCP !== 'number' || this.vBCFCP < 0)) {
      throw new DomainError('Valor da BC do ICMS FCP (vBCFCP) deve ser um número não negativo, se informado.');
    }

    if (this.vFCP !== undefined && (typeof this.vFCP !== 'number' || this.vFCP < 0)) {
      throw new DomainError('Valor do ICMS FCP (vFCP) deve ser um número não negativo, se informado.');
    }
    ...
    if (this.pMVAST !== undefined && (typeof this.pMVAST !== 'number' || this.pMVAST < 0 || this.pMVAST > 100)) {
      throw new DomainError('Percentual da Margem de Valor Adicionado ICMS ST (pMVAST) deve ser um número entre 0 e 100, se informado.');
    }

    if (this.pRedBCST !== undefined && (typeof this.pRedBCST !== 'number' || this.pRedBCST < 0 || this.pRedBCST > 100)) {
      throw new DomainError('Percentual de redução da BC ICMS ST (pRedBCST) deve ser um número entre 0 e 100, se informado.');
    }
    ...
    if (this.vICMSSTDeson !== undefined && (typeof this.vICMSSTDeson !== 'number' || this.vICMSSTDeson < 0)) {
      throw new DomainError('Valor do ICMS ST desonerado (vICMSSTDeson) deve ser um número não negativo, se informado.');
    }
    ...
    if (this.motDesICMSST !== undefined && typeof this.motDesICMSST !== 'string' && !allowedMotDesICMSST.includes(this.motDesICMSST)) {
      throw new DomainError(`Motivo da desoneração do ICMS ST (motDesICMSST) deve ser '3', '9' ou '12', se informado.`);
    }

    if (this.vICMSOp !== undefined && (typeof this.vICMSOp !== 'number' || this.vICMSOp < 0)) {
      throw new DomainError('Valor do ICMS Op (vICMSOp) deve ser um número não negativo, se informado.');
    }

    if (this.pDif !== undefined && (typeof this.pDif !== 'number' || this.pDif < 0 || this.pDif > 100)) {
      throw new DomainError('Percentual de diferença de alíquota (pDif) deve ser um número entre 0 e 100, se informado.');
    }

    if (this.vICMSDif !== undefined && (typeof this.vICMSDif !== 'number' || this.vICMSDif < 0)) {
      throw new DomainError('Valor do ICMS Dif (vICMSDif) deve ser um número não negativo, se informado.');
    }
  }
