...
export class ICMS10 {
  ...
  public validateOrThrow() {
    ...
    if (this.CST !== '10') {
      throw new DomainError('CST para ICMS10 deve ser obrigatoriamente "10".');
    }
    ...
    if (this.vFCPPST !== undefined && (typeof this.vFCPPST !== 'number' || this.vFCPPST < 0)) {
      throw new DomainError('Valor do ICMS FCP ST (vFCPPST) deve ser um número não negativo, se informado.');
    }
