...
export class ICMS51 {
  ...
  public validateOrThrow() {
    ...
    if (this.CST !== '51') {
      throw new DomainError('CST para ICMS51 deve ser obrigatoriamente "51".');
    }
    ...
    if (this.cBenefRBC !== undefined && typeof this.cBenefRBC !== 'string') {
      throw new DomainError('Código do benefício fiscal na BC (cBenefRBC) deve ser uma string, se informado.');
    }
    ...
    if (this.vICMSOp !== undefined && (typeof this.vICMSOp !== 'number' || this.vICMSOp < 0)) {
      throw new DomainError('Valor do ICMS da Operação (vICMSOp) deve ser um número não negativo, se informado.');
    }

    if (this.pDif !== undefined && (typeof this.pDif !== 'number' || this.pDif < 0 || this.pDif > 100)) {
      throw new DomainError('Percentual do diferimento (pDif) deve ser um número entre 0 e 100, se informado.');
    }

    if (this.vICMSDif !== undefined && (typeof this.vICMSDif !== 'number' || this.vICMSDif < 0)) {
      throw new DomainError('Valor do ICMS diferido (vICMSDif) deve ser um número não negativo, se informado.');
    }
    ...
    if (this.vBCFCP !== undefined && (typeof this.vBCFCP !== 'number' || this.vBCFCP < 0)) {
      throw new DomainError('Valor da BC do FCP (vBCFCP) deve ser um número não negativo, se informado.');
    }
    ...
    if (this.pFCPDif !== undefined && (typeof this.pFCPDif !== 'number' || this.pFCPDif < 0 || this.pFCPDif > 100)) {
      throw new DomainError('Percentual do FCP diferido (pFCPDif) deve ser um número entre 0 e 100, se informado.');
    }

    if (this.vFCPDif !== undefined && (typeof this.vFCPDif !== 'number' || this.vFCPDif < 0)) {
      throw new DomainError('Valor do FCP diferido (vFCPDif) deve ser um número não negativo, se informado.');
    }

    if (this.vFCPEfet !== undefined && (typeof this.vFCPEfet !== 'number' || this.vFCPEfet < 0)) {
      throw new DomainError('Valor do FCP efetivo (vFCPEfet) deve ser um número não negativo, se informado.');
    }
  }
