...
// import { IdLoteService } from 'src/core/nfe/infrastructure/sefaz/services/idLote.service';
...
//   constructor(
//     @Inject(forwardRef(() => IdLoteService))
...
//     return this.buildService.buildXML(objectFormat, cNF, cDV, chave);
//   }
