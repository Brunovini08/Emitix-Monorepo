...
//     }
//     try {
//       const xml = await this.nfceService.consultaNFe(
//         body,
//         certificate,
//         password,
//         1,
...
//     }
//     try {
//       const xml = await this.nfceService.statusServico(
//         body,
//         certificate,
//         password,
//         2,
...
//     }
//     try {
//       const xml = await this.nfceService.distribuicaoDfe(
//         body,
//         certificate,
//         password,
//         0,
...
//     try {
//       const userId = req.user?.sub;
//       const xml = await this.nfceService.evento(
//         body,
//         certificate,
//         password,
//         4,
