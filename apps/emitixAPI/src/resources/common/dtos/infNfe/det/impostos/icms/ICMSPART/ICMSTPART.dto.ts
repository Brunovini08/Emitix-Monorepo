...
export class ICMSPARTDto {
  ...
  @Equals('90')
  @IsString()
  CST: string; // Código de Situação Tributária (CST) do ICMS (90)
  ...
  @IsOptional()
  @Type(() => TDec_0302a04Opc)
  pBCOp: TDec_0302a04Opc; // Percentual da BC do ICMS ST (%)

  @IsOptional()
  @Type(() => TUf)
  UFST: TUf; // Unidade da Federação do ICMS ST (%)
}
