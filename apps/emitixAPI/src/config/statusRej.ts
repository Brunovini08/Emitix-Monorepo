export const REJ_SEFAZ = {
  ...
  "206": "Rejeição: Numeração da NF-e já está inutilizada na Base de Dados da SEFAZ",
  ...
  "292": "Rejeição: Certificado de Assinatura sem CNPJ/CPF",
  ...
  "305": "Rejeição: Destinatário bloqueado na UF [NT 2019.001]",
  "306": "Rejeição: IE do destinatário não está ativa na UF [NT 2019.001]",
  "315": "Rejeição: Data de Emissão anterior ao início da autorização de Nota Fiscal na UF",
  "316": "Rejeição: Chave de Acesso referenciada com a mesma Chave de Acesso da Nota Fiscal atual [nOcor:nnn]",
  ...
  "331": "Rejeição: Informar o CNPJ ou CPF do adquirente ou do encomendante nesta forma de importação",
  ...
  "336": "Rejeição: Informado o grupo de exportação no item em operação que não é com exterior [nItem: nnn]",
  ...
  "395": "Rejeição: Endereço do site da UF da Consulta via QR-Code diverge do previsto",
  "396": "Rejeição: Parâmetro do QR-Code inexistente: [Nome do parâmetro do QR Code: xxx)]",
  "397": "Rejeição: Parâmetro do QR-Code divergente da Nota Fiscal: [Nome do parâmetro do QR Code:: xxx)]",
  "398": "Rejeição: Parâmetro Versão informada no QR-Code diverge do previsto (“2”)",
  "399": "Rejeição: Parâmetro de Identificação do destinatário no QR-Code para Nota Fiscal sem identificação do destinatário",
  "400": "Rejeição: Parâmetro do QR-Code não está no formato hexadecimal: [Nome do parâmetro do QR Code: xxx)]",
  ...
  "410": "Rejeição: UF informada no campo cUF não é atendida pelo WebService (NT 2018.004)",
  ...
  "434": "Rejeição: NF-e sem indicativo do intermediador (NT 2020.006)",
  "435": "Rejeição: NF-e não pode ter o indicativo do intermediador (NT 2020.006)",
  "436": "Rejeição: Código do meio de pagamento inexistente",
  "437": "Rejeição: CNPJ da instituição de pagamento inválido (NT 2020.006)",
  "438": "Rejeição: Obrigatória as informações do intermediador da transação para operação por site de terceiros (NT 2020.006)",
  "439": "Rejeição: Informações do intermediador da transação para operação por site de terceiros preenchido indevidamente (NT 2020.006)",
  "440": "Rejeição: CNPJ do intermediador da transação inválido (NT 2020.006)",
  ...
  "452": "Rejeição: Processo de Emissão pelo Fisco incompatível com a Série da NF",
  "453": "Rejeição: Solicitada resposta assíncrona para Lote com somente 1 (uma) NFC-e",
  ...
  "461": "Rejeição: Informado campos de percentual de GLP e/ou GLGNn e/ou GLGNi para produto diferente de GLP [nItem: 999]",
  ...
  "489": "Rejeição: CNPJ informado inválido (DV ou zeros) [nItem: 999]",
  ...
  "523": "Rejeição: CFOP não é de Operação Estadual e UF emitente igual à UF destinatário [nItem: 999]",
  "524": "Rejeição: Chave de Acesso referenciada com Ano-Mês inválido [nOcor: 999]",
  ...
  "528": "Rejeição: Valor do ICMS difere do produto BC e Alíquota [nItem: 999]",
  ...
  "548": "Rejeição: NF modelo 1 referenciada com data de emissão inválida [nOcor:nnn]",
  "549": "Rejeição: CNPJ da NF referenciada de produtor inválido [nOcor: 999]",
  ...
  "599": "Rejeição: CFOP de Importação e não informado dados de II [nItem: 999]",
  ...
  "625": "Rejeição: Inscrição SUFRAMA deve ser informada na venda com isenção para ZFM [nItem: 999]",
  "626": "Rejeição: CFOP de operação isenta para ZFM diferente do previsto [nItem: 999]",
  "627": "Rejeição: O valor do ICMS desonerado deve ser informado [nItem: 999]",
  "628": "Rejeição: Total da NF superior ao valor limite estabelecido pela SEFAZ [Limite]",
  "629": "Rejeição: Valor do Produto difere do produto Valor Unitário de Comercialização e Quantidade Comercial [nItem: 999]",
  "630": "Rejeição: Valor do Produto difere do produto Valor Unitário de Tributação e Quantidade Tributável [nItem: 999]",
  ...
  "660": "Rejeição: CFOP de Combustível e não informado grupo de combustível da NF-e [nItem: nnn]",
  ...
  "681": "Rejeição: Duplicidade de NF Modelo 1 referenciada (CNPJ, Modelo, Série e Número) [nOcor: nnn]",
  ...
  "691": "Rejeição: Chave de Acesso da NF-e diverge da Chave de Acesso do EPEC [Chave EPEC: xxxxxxxxx]",
  "692": "Rejeição: Existe EPEC registrado para esta Série e Número [Chave EPEC: xxxxxxxxxxx]",
  "693": "Rejeição: Alíquota de ICMS superior à definida para a operação interestadual [nItem: 999]",
  ...
  "701": "Rejeição: Não informado Nota Fiscal referenciada (Lançamento relativo a Cupom Fiscal) [nItem: nnn]",
  ...
  "714": "Rejeição: NFC-e com contingência inválida (tpEmis=2, 4 (a critério da UF) ou 5)",
  ...
  "734": "Rejeição: NFC-e com Unidade de Comercialização inválida [nItem: 999]",
  "735": "Rejeição: NFC-e com Unidade de Tributação inválida [nItem: 999]",
  ...
  "739": "Rejeição: Código de País do ISSQN Inexistente",
  ...
  "774": "Rejeição: NFC-e com indicador de item não participante do total [nItem: 999]",
  "775": "Rejeição: Modelo da NFC-e diferente de 65",
  "777": "Rejeição: Obrigatória a informação do NCM completo (redação dada pela NT 2013/005 v 1.20) [nItem: 999]",
  "778": "Rejeição: Informado NCM inexistente[nItem:nnn]",
  "779": "Rejeição: NFC-e com NCM incompatível [nItem: 999]",
  ...
  "806": "Rejeição: Operação com ICMS-ST sem informação do CEST [nItem: 999]",
  ...
  "813": "Rejeição: QR-Code com sequência de escape para o e-comercial. Usar CDATA",
  ...
  "817": "Rejeição: Unidade Tributável incompatível com o NCM informado na operação com Comércio Exterior [nItem: 999]",
  "818": "Rejeição: Informação de Solicitação de NFF não pode estar preenchido",
  "819": "Rejeição: Rejeição: CNPJ incorreto na assinatura da NFF",
  "820": "Rejeição: Informado produto fiscal de NFF",
  "821": "Rejeição: Data-Hora de Entrega superior a data de emissão do evento",
  "822": "Rejeição: Data-Hora do Hash do Comprovante de Entrega superior a data de emissão do evento (*1)",
  "823": "Rejeição: Data-Hora de Entrega inferior a data de emissão da NF-e",
  "824": "Rejeição: Data-Hora do Hash do Comprovante de Entrega inferior a data de emissão da NF-e (*1)",
  ...
  "832": "Rejeição: CNPJ incorreto na transmissão da NFF",
  "833": "Rejeição: Informada embalagem do produto",
  "834": "Rejeição: Informação de Solicitação de NFF não preenchida",
  ...
  "854": "Rejeição: Unidade Tributável (tag:uTrib) incompatível com produto informado [nItem: 999]",
  "855": "Rejeição: Somatório percentuais de GLP derivado do petróleo, GLGNn e GLGNi diferente de 100 [nItem: 999].",
  ...
  "858": "Rejeição: Grupo de Tributação informado indevidamente [nItem: 999]",
  ...
  "870": "Rejeição: Data de validade incompatível com data de fabricação [nItem: 999]",
  ...
  "875": "Rejeição: Percentual de FCPST inválido [nItem: 999]",
  "876": "Rejeição: Operação interestadual para Consumidor Final e valor do FCP informado em campo diferente de vFCPUFDest (id:NA13) [nItem: 999]",
  ...
  "879": "Rejeição: Informado item “Produzido em Escala NÃO Relevante” e não informado CNPJ do Fabricante [nItem: 999]",
  ...
  "906": "Rejeição: Não informados os campos para informações do ICMS Efetivo. [nItem: nnn] [NT 2018.005]",
  ...
  "910": "Rejeição: Chave de Acesso NF-e Substituta inválida () [NT 2018.004]",
  "911": "Rejeição: Chave de Acesso NF-e Substituta incorreta () [NT 2018.004]",
  "912": "Rejeição: NF-e Substituta inexistente [NT 2018.004]",
  "913": "Rejeição: NF-e Substituta Denegada ou Cancelada [NT 2018.004]",
  "914": "Rejeição: Data de emissão da NF-e Substituta maior que 2 horas da data de emissão da NF-e a ser cancelada [NT 2018.004]",
  "915": "Rejeição: Valor total da NF-e Substituta difere do valor da NF-e a ser cancelada [NT 2018.004]",
  "916": "Rejeição: Valor total do ICMS da NF-e Substituta difere do valor da NF-e a ser cancelada [NT 2018.004]",
  "917": "Rejeição: Identificação do destinatário da NF-e Substituta difere da identificação do destinatário da NF-e a ser cancelada. [NT 2018.004]",
  "918": "Rejeição: Quantidade de itens da NF-e Substituta difere da quantidade de itens da NF-e a ser cancelada. [NT 2018.004]",
  "919": "Rejeição: Item da NF-e Substituta difere do mesmo item da NF-e a ser cancelada. [NT 2018.004]",
  "920": "Rejeição: Tipo de Emissão inválido no Cancelamento por Substituição [NT 2018.004]",
  "922": "Rejeição: Contranota de Produtor só pode referenciar NF-e ou NF de Produtor Modelo 4 [NT 2019.001]",
  "923": "Rejeição: Referenciado documento de operação interna em operação interestadual ou com o exterior [NT 2019.001]",
  "924": "Rejeição: Informado Cupom Fiscal referenciado. [NT 2019.001]",
  "925": "Rejeição: NF-e com identificação de estrangeiro e inscrição estadual informada para destinatário [NT 2019.001]",
  "926": "Rejeição: Operação com Exterior e país de destino igual a Brasil. [NT 2019.001]",
  "927": "Rejeição: Número do item fora da ordem sequencial. [NT 2019.001]",
  "928": "Rejeição: Informado código de benefício fiscal para CST sem benefício fiscal [nItem: nnn] [NT 2019.001]",
  "929": "Rejeição: Informado CST de diferimento sem as informações de diferimento [nItem: nnn] [NT 2019.001]",
  "930": "Rejeição: CST com benefício fiscal e não informado o código de benefício fiscal [nItem: nnn] [NT 2019.001]",
  "931": "Rejeição: CST não corresponde ao tipo de código de benefício fiscal [nItem: nnn] [NT 2019.001]",
  "932": "Rejeição: Informada modalidade de determinação da BC da ST como MVA e não informado o campo pMVAST [nItem: nnn] [NT 2019.001]",
  "933": "Rejeição: Informada modalidade de determinação da BC da ST diferente de MVA e informado o campo pMVAST [nItem: nnn] [NT 2019.001]",
  "934": "Rejeição: Não informado valor do ICMS desonerado ou o Motivo de desoneração [nItem: nnn] [NT 2019.001]",
  "935": "Rejeição: Valor total da Base de Cálculo superior ao valor limite estabelecido [Valor Limite: R$ XXX.XXX,XX] (valor definido pela UF) [NT 2019.001]",
  ...
  "970": "Rejeição: Código de País inexistente [local de retirada/entrega] [NT 2018.005]",
  "971": "Rejeição: IE inválida [local de retirada/entrega] [NT 2018.005]",
  "972": "Rejeição: Obrigatória as informações do responsável técnico [NT 2018.005]",
  "973": "Rejeição: CNPJ do responsável técnico inválido [NT 2018.005]",
  "974": "Rejeição: CNPJ do responsável técnico diverge do cadastrado [NT 2018.005]",
  "975": "Rejeição: Obrigatória a informação do identificador do CSRT e do Hash do CSRT [NT 2018.005]",
  "976": "Rejeição: Identificador do CSRT não cadastrado na SEFAZ [NT 2018.005]",
  "977": "Rejeição: Identificador do CSRT revogado [NT 2018.005]",
  "978": "Rejeição: Hash do CSRT diverge do calculado [NT 2018.005]",
