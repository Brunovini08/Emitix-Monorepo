...
import { TAmb } from 'src/nfe/reusable/types/primitivies_types/TAmb';
import { TCodMunIBGE } from 'src/nfe/reusable/types/primitivies_types/TCodMunIBGE';
import { TDateTimeUTC } from 'src/nfe/reusable/types/primitivies_types/TDateTimeUTC';
import { TMod } from 'src/nfe/reusable/types/primitivies_types/TMod';
