...
import type { IIndicadorIEDest } from '../../../../../reusable/interfaces/IIndicadorIEDest';
...
import { TIeDestNaoIsento } from 'src/nfe/reusable/types/primitivies_types/TIeDestNaoIsento';
